...
function calculateFiberDiscountBetween(selectedPosA,selectedPosB){
  ...
  console.log('Within calculateFiberDiscountBetween'); 
  selectedPosA = {lat: selectedPosA.lat, lon: selectedPosA.lng}
  selectedPosB = {lat: selectedPosB.lat, lon: selectedPosB.lng}
  // Initialize the output we will be returning. 
  var output = {num: 0, discount: 0}
  console.log(store.fibers);
  store.fibers.forEach(function(fib) {
    //console.log(fib); 
    // Determine the center
    var center = {lat: Number(fib.center.latitude), lon: Number(fib.center.longitude)}
    ...
    if (isBetween(selectedPosA,selectedPosB,center)) {
      ...
      //console.log(fiberStart); 
      //console.log(fiberEnd); 
  ...
  console.log('returning num:' + output.num);
  console.log('returning discount:' + output.discount); 
...
function isBetween(point1,point2,fiber)
{
  ...
  console.log('between distance' + distanceBetween)
  ...
  console.log('distanceFromMid' + distanceFromMid)
