  ...
  render(){
    ...
    if(this.props.isLoading){
      ...
      rowElements = _.map(fibers, (fiber, i) => {
        ...
        const className = fiber.isSelected && this.state.showAllFibers ? 'row orange black-text fiber' : 'row fiber'
        if (fiber.isSelected || this.state.showAllFibers) {
          return <li key={i}>
            <div className="collapsible-header grey darken-2">
            ...
            <div className="collapsible-body">
              ...
              <div dangerouslySetInnerHTML={{__html: hazards.highway}}/>
              <div dangerouslySetInnerHTML={{__html: hazards.lake}}/>
              <div dangerouslySetInnerHTML={{__html: hazards.bridge}}/>
              <div dangerouslySetInnerHTML={{__html: hazards.school}}/>
    ...
    return <div className="grey darken-3 white-text" id="tableContainer">
      { tableHeader }
      { showAll }
      { rowHeaders }
